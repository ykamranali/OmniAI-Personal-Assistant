...
struct TORCH_API _upsample_lanczos2d_aa_vec {
  using schema = at::Tensor (const at::Tensor &, at::OptionalSymIntArrayRef, bool, ::std::optional<at::ArrayRef<double>>);
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::_upsample_lanczos2d_aa";
  static constexpr const char* overload_name = "vec";
  static constexpr const char* schema_str = "_upsample_lanczos2d_aa.vec(Tensor input, SymInt[]? output_size, bool align_corners, float[]? scale_factors) -> Tensor";
...
struct TORCH_API _upsample_lanczos2d_aa_out {
  ...
  static constexpr const char* schema_str = "_upsample_lanczos2d_aa.out(Tensor self, SymInt[2] output_size, bool align_corners, float? scales_h=None, float? scales_w=None, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API _upsample_lanczos2d_aa {
  using schema = at::Tensor (const at::Tensor &, c10::SymIntArrayRef, bool, ::std::optional<double>, ::std::optional<double>);
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::_upsample_lanczos2d_aa";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_upsample_lanczos2d_aa(Tensor self, SymInt[2] output_size, bool align_corners, float? scales_h=None, float? scales_w=None) -> Tensor";
