...
struct TORCH_API _upsample_lanczos2d_aa_backward_grad_input {
  ...
  static constexpr const char* name = "aten::_upsample_lanczos2d_aa_backward";
  static constexpr const char* overload_name = "grad_input";
  static constexpr const char* schema_str = "_upsample_lanczos2d_aa_backward.grad_input(Tensor grad_output, SymInt[2] output_size, SymInt[4] input_size, bool align_corners, float? scales_h=None, float? scales_w=None, *, Tensor(a!) grad_input) -> Tensor(a!)";
...
struct TORCH_API _upsample_lanczos2d_aa_backward {
  ...
  static constexpr const char* schema_str = "_upsample_lanczos2d_aa_backward(Tensor grad_output, SymInt[2] output_size, SymInt[4] input_size, bool align_corners, float? scales_h=None, float? scales_w=None) -> Tensor";
